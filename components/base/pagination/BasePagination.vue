      ...
      <div>
        <nav class="relative z-0 inline-flex rounded-md shadow-sm -space-x-px" aria-label="Pagination">
          ...
          >
            ...
            <IconsChevronLeft class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" :aria-hidden="true" />
          </button>
          ...
          >
            ...
            <IconsChevronRight class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" :aria-hidden="true" />
          </button>
        </nav>
      </div>
    </div>
