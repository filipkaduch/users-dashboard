<template>
  ...
  >
    ...
    <span class="pointer-events-none absolute top-6 right-6 text-gray-300 group-hover:text-gray-400" :aria-hidden="true">
      <IconsArrowRight class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" :aria-hidden="true" />
    </span>
  </NuxtLink>

  <div v-else class="relative group bg-gray-50 p-6 rounded-lg border border-gray-200">
    <div>
      <span class="rounded-lg inline-flex p-3 bg-gray-100 text-gray-600 ring-4 ring-white">
        <slot name="icon">
